...
function createCard(name, link) {
  ...
  newCard
    .querySelector(".element__delite")
    .addEventListener("click", deliteCard); //слушатель делита
...
const newCardSubmitForm = popupAddCard.querySelector(".form_type_add-card"); // форма добавл карточки!!!!!!!!
